...
-- CreateTable
CREATE TABLE "public"."CoverLatter" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "content" TEXT NOT NULL,
    "jobDescription" TEXT,
    ...
    CONSTRAINT "CoverLatter_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "CoverLatter_userId_key" ON "public"."CoverLatter"("userId");

-- CreateIndex
CREATE INDEX "CoverLatter_userId_idx" ON "public"."CoverLatter"("userId");
...
-- AddForeignKey
ALTER TABLE "public"."CoverLatter" ADD CONSTRAINT "CoverLatter_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
